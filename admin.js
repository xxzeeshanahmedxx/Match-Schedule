...
async function saveMatch(matchId) {
  ...
  if (s1 !== '' || s2 !== '') {
    ...
    if (s1 === '' || s2 === '') {
      alert('Enter both scores, or leave both blank to save only date/time/mode.');
      return;
    }
    ...
    body.score1 = Number(s1);
    body.score2 = Number(s2);
  }
